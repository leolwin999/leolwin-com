...
## Flash back
So far, we've learnt the concept of heap in [Part 1](https://leolwin.netlify.app/posts/what-the-heap-part-1) and about malloc, calloc and realloc in [Part 2](https://leolwin.netlify.app/posts/what-the-heap-part-2). We've built and now it's time to break! >:) 
...
## A Word of Caution
We are about to write and exploit a deliberately vulnerable program. This is for educational purposes only, to understand how software can fail.
...
## Final thought
We've gone from metaphors to low-level reality for the heap.We learned allocator internals, flags, chunk headers, bins, and how attackers and defenders think.
  
That's the end of our heap series :) 
  
And don't forget, reverse engineering can be challenging and time-consuming process. Don't get discouraged by initial confusion. Consistent effort is key to developing your skills.
